'use strict';
 ...
 /**
 * {@link expect} the actual (a {@link Spy}) to have been called with particular context and arguments at least once.
 * @function
 * @name matchers#toHaveBeenCalledWithContext
 * @param {Object} - The context to look for
 * @param {...Object} - The arguments to look for
 * @example
 * expect(mySpy).toHaveBeenCalledWithContext(thisArg, 'foo', 'bar', 2);
 */
function toHaveBeenCalledWithContext(util, customEqualityTesters) {
...
module.exports = toHaveBeenCalledWithContext;
